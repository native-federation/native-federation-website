...
> **Note:** This repository is primarily for compatibility testing. For a working starter, see the [Example](example.md).

## Related

- [Example](example.md) — a working starter example
