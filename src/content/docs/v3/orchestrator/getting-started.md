...
> **Note:** The orchestrator is a _host-side_ library. Your remotes are still built the usual way ([core](/docs/v4/core/getting-started/), [Angular adapter](/docs/v4/angular-adapter/), [esbuild adapter](/docs/v4/adapters/esbuild/), …) and just need to publish a standard `remoteEntry.json`.
