...
- [Runtime (v4)](runtime.md) — the current runtime page.
- [Migration to v4](migration-v4.md) — the upgrade path, including the bootstrap rewrite.
- [Legacy Runtime](../runtime/index.md) — the classic runtime package itself, and why it was superseded.
- [v3 vs v4](../v3-vs-v4.md) — every breaking change between the lines, in one place.
