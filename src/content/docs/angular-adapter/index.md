...
- [Runtime](runtime.md) — `initFederation`, the orchestrator, threading the loader through DI, and dynamic remotes. The v3 surface — a plain re-export of the classic runtime — lives on [Runtime (v3)](runtime-v3.md).
