...
> **Note:** **On v3?** The v3 adapter is a straight re-export of the classic `@softarc/native-federation-runtime`, and its API differs from what is documented here — see [Runtime (v3)](runtime-v3.md). To move across, see [Migration to v4](migration-v4.md).
...
- [Runtime (v3)](runtime-v3.md) — the same page for the v3 adapter, which re-exports the classic runtime.
