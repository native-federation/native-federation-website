...
- [Angular Adapter — Runtime](angular-adapter/runtime.md) — the Angular bootstrap split, threading the loader through DI, and dynamic remotes. _v4 (v3 on its [own page](/docs/v3/angular-adapter/runtime/))._
